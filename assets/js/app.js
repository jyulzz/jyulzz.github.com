...
/*
 * Initializing Foundation scripts.
 */
(0, _jquery2.default)(document).foundation();

/*
 * DOM manipulating functions are encapsulated in a Document.Ready function.
 */
(0, _jquery2.default)(document).ready(function () {
  ...
  if ((0, _jquery2.default)('header').length) {

    /*
     * Utility function that calculates whether an element is currently visible
     * within the viewport.
     */
    var toggleHeaderNavigationIllustration = function toggleHeaderNavigationIllustration() {
      var trigger = (0, _jquery2.default)('#hello figure');
      var target = (0, _jquery2.default)('#navigation .logo .me');
      if (trigger.length) {
        if (trigger.is(':in-viewport()')) {
    ...
    /*
     * Triggering the toggleHeaderNavigationIllustration function on
     * window scroll.
     */
     ...
     * Make header sticky.
     */
    var elem = new _foundationSites2.default.Sticky((0, _jquery2.default)('header'), {
      stickyOn: 'small',
      marginTop: 0,
      checkEvery: 0
    });
    ...
    /*
     * Use Magellan to add an active state to the main navigation element which
     * corresponds to the currently visible content section
     * (used on Index page).
     */
    new _foundationSites2.default.Magellan((0, _jquery2.default)("#navigation .sections"), {
      activeClass: 'active',
      offset: 100,
      threshold: 100
    });(0, _jquery2.default)(window).on('scroll', toggleHeaderNavigationIllustration);

    /*
     * When the user clicks on a navigation tag, make this tab active.
     */
    (0, _jquery2.default)("nav#navigation .sections .tab a").on('click', function () {
      (0, _jquery2.default)('nav#navigation .sections .tab a').removeClass('active');
  ...
  /*
   * Activation and de-activation of the X-Ray mode (used on Index page).
   */
  (0, _jquery2.default)("a#xray-mode").on('click', function () {
    if ((0, _jquery2.default)('body').hasClass('xray')) {
      (0, _jquery2.default)('body').removeClass('xray');
      (0, _jquery2.default)(this).html('Turn X-Ray Mode On  ○');
    } else {
      (0, _jquery2.default)(this).html('Turn X-Ray Mode Off ●');
      (0, _jquery2.default)('body').addClass('xray');
    }
  });
  ...
  /*
   * When a user clicks on a note within a case, send him to the corresponding
   * reference and highlight said reference.
   */
  (0, _jquery2.default)("section#case sup a").on('click', function () {
    (0, _jquery2.default)('.notes-references ul li').removeClass('highlighted');
    (0, _jquery2.default)((0, _jquery2.default)(this).attr('href')).parent().addClass('highlighted');
  });
...
_jquery2.default.extend(_jquery2.default.expr.pseudos || _jquery2.default.expr[':'], {
  // if $.expr.createPseudo is available, use it
  'in-viewport': _jquery2.default.expr.createPseudo ? _jquery2.default.expr.createPseudo(function (argsString) {
...
_jquery2.default.fn.isInViewport = function (options) {
  return this.filter(function (i, el) {
    return isInViewport(el, options);
  });
};

_jquery2.default.fn.run = run;
  ...
  args.forEach(function (arg) {
    if (typeof arg !== 'function') {
      ...
      [].slice.call(this$1).forEach(function (t) {
        return arg.call((0, _jquery2.default)(t));
      });
    }
  });
...
function getScrollbarWidth(viewport) {
  ...
  var el = (0, _jquery2.default)('<div></div>').css({
    width: '100%'
  });
  viewport.append(el);
...
function isInViewport(element, options) {
  ...
  var $viewport = settings.viewport.jquery ? settings.viewport : (0, _jquery2.default)(settings.viewport);

  if (!$viewport.length) {
    console.warn('isInViewport: The viewport selector you have provided matches no element on page.');
    console.warn('isInViewport: Defaulting to viewport as window');
    $viewport = (0, _jquery2.default)(window);
  }
...
function getSelectorArgs(argsString) {
  if (argsString) {
    ...
    return {
      ...
      viewport: args[1] ? (0, _jquery2.default)(args[1].trim()) : void 0
    };
  }
  return {};
}
